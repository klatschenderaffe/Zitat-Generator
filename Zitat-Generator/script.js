...
function generiereZitat() {
    var zitatearrayLaenge = zitatearray.length - 1;
    var zufallszitatnummer = Math.round(Math.random() * zitatearrayLaenge);
    var zufallszitat = zitatearray[zufallszitatnummer];
